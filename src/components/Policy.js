...
const Policy = () => {
	return (
		<div>
			...
			<ul>
				...
				<li>
					<p>
						...
						this Agreement) refers to SAMC, Chondipur.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to SAMC, accessible from{' '}
						<a
							href='imfo@samcbangladesh.org'
							rel='external nofollow noopener'
							target='_blank'>
							imfo@samcbangladesh.org
						</a>
					</p>
				</li>
				<li>
			...
			<ul>
				<li>By email: samcbangladesh@gmail.com</li>
			</ul>
		</div>
	);
};
